		       ...
		       <c:forEach items="${list}" var="vo">
				...
				<div id="ampaginationsm" style="margin-left: 450px;"></div>
				 ...
				 <form action="/coinweb/freeboard_search.do?rpage=${rpage}" method="get">
					...
					<button type="submit" class="communitySearchBtn" style="width: 100px; border-radius: 10px; height: 30px;" >검색</button>
					
					<a href="/coinweb/freeboard.do"><button  type="button" class="communitySearchBtn" style="width: 100px; border-radius: 10px; height: 30px;" >전체 페이지</button></a>
				
					<a href="/coinweb/freeboard_write.do"><button type="button" class=" btn-warning form-group-write" style="width: 100px; border-radius : 10px; height: 30px;">글쓰기</button></a>
				</form>
				</div>
		</div>
